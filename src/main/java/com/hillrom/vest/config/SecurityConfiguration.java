...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/logs/**").hasAuthority(AuthoritiesConstants.SUPER_ADMIN)
            ...
            .antMatchers("/metrics/**").hasAuthority(AuthoritiesConstants.SUPER_ADMIN)
            .antMatchers("/health/**").hasAuthority(AuthoritiesConstants.SUPER_ADMIN)
            .antMatchers("/trace/**").hasAuthority(AuthoritiesConstants.SUPER_ADMIN)
            .antMatchers("/dump/**").hasAuthority(AuthoritiesConstants.SUPER_ADMIN)
            .antMatchers("/shutdown/**").hasAuthority(AuthoritiesConstants.SUPER_ADMIN)
            .antMatchers("/beans/**").hasAuthority(AuthoritiesConstants.SUPER_ADMIN)
            .antMatchers("/configprops/**").hasAuthority(AuthoritiesConstants.SUPER_ADMIN)
            .antMatchers("/info/**").hasAuthority(AuthoritiesConstants.SUPER_ADMIN)
            .antMatchers("/autoconfig/**").hasAuthority(AuthoritiesConstants.SUPER_ADMIN)
            .antMatchers("/env/**").hasAuthority(AuthoritiesConstants.SUPER_ADMIN)
            .antMatchers("/trace/**").hasAuthority(AuthoritiesConstants.SUPER_ADMIN)
            .antMatchers("/api-docs/**").hasAuthority(AuthoritiesConstants.SUPER_ADMIN)
            .antMatchers("/api/clinics/**").hasAnyAuthority(AuthoritiesConstants.SUPER_ADMIN, AuthoritiesConstants.RC_ADMIN)
            .antMatchers("/api/hillromteamuser/**").hasAnyAuthority(AuthoritiesConstants.SUPER_ADMIN)
            .antMatchers("/protected/**").authenticated()
            .antMatchers("/api/user/{id}/changeSecurityQuestion").authenticated()
            .antMatchers("/api/user/**").hasAnyAuthority(AuthoritiesConstants.SUPER_ADMIN, AuthoritiesConstants.RC_ADMIN)
            .antMatchers("/api/patient/**").hasAnyAuthority(AuthoritiesConstants.SUPER_ADMIN)
