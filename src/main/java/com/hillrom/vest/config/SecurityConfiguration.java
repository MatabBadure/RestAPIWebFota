...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/patient/{id}/protocol").hasAnyAuthority(AuthoritiesConstants.ADMIN)
            ...
            .antMatchers("/api/validateCredentials").hasAnyAuthority(AuthoritiesConstants.HCP , AuthoritiesConstants.CLINIC_ADMIN)
