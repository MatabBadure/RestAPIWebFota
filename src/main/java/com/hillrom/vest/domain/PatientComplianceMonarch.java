...
@Entity
@Audited
@Table(name="PATIENT_COMPLIANCE_MONARCH")
public class PatientComplianceMonarch extends AbstractAuditingEntity implements Serializable{
	...
	public PatientComplianceMonarch() {
		super();
	}
	...
	public PatientComplianceMonarch(LocalDate date,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PatientComplianceMonarch other = (PatientComplianceMonarch) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "PatientComplianceMonarch [id=" + id + ", score=" + score + ", date=" + date + ", patient=" + patient
