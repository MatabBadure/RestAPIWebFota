...
@Audited
@Entity
@Table(name = "PATIENT_PROTOCOL_DATA_MONARCH")
@SQLDelete(sql="UPDATE PATIENT_PROTOCOL_DATA_MONARCH  SET is_deleted = 1 where id = ?")
public class PatientProtocolDataMonarch extends AbstractAuditingEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PatientProtocolDataMonarch other = (PatientProtocolDataMonarch) obj;
