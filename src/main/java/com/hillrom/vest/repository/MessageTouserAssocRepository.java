...
public interface MessageTouserAssocRepository extends
	...
	// To get the list of messages from clinic to patients
		@Query("Select messageTouserAssoc.id, messageTouserAssoc.isArchived, messageTouserAssoc.isRead, messageTouserAssoc.messages.id,"
				+ "messageTouserAssoc.messages.messageDatetime, "
