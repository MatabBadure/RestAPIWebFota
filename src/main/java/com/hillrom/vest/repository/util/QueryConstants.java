...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------//
	...
	public static final String PATIENT_STATISTICS_FOR_ACTIVE_CLINICS="SELECT 'HCP', "
			+ "       puserid, "
			+ "       pfirstname, "
			+ "       plastname, "
			+ "       huserid, "
	...
	public static final String QUERY_FOR_ACTIVE_CLINICS_MONARCH="SELECT "
			+ "   'HCP', "
			+ "   puserid, "
			+ "   pfirstname, "
			+ "   plastname, "
	...
	public static final String QUERY_FIND_BY_USER_ID="Select us.*,ua.authority_name,group_concat(cua.clinics_id),group_concat(cpa.clinic_id),group_concat(eua.entity_id) "
	...
	public static final String QUERY_FIND_PATIENT_STATISTICS_CAREGIVER_DETAILS="select puserid,pfirstname,plastname,cgvr_id,CONCAT(clastName,' ', cfirstName) as cname,pc.missed_therapy_count,pc.is_settings_deviated,pc.is_hmr_compliant, "
	 + "cemail, "
	...
	public static final String QUERY_FIND_BY_DEVICETYPE_AND_PATIENT_COUNT=" Select dtype,if(count is null,0,count) from "
	...
	public static final String QUERY_FIND_PATIENT_STATISTICS_CAREGIVER="select puserid,pfirstname,plastname,cgvr_id,CONCAT(clastName,' ', cfirstName) as cname,pc.missed_therapy_count,pc.is_settings_deviated,pc.is_hmr_compliant,"
	...
	public static final String QUERY_PATIENT_STATISTICS_CAREGIVER_DETAILS_MONARCH ="select puserid,pfirstname,plastname,cgvr_id,CONCAT(clastName,' ', cfirstName) as cname,pc.missed_therapy_count,pc.is_settings_deviated,pc.is_hmr_compliant, "
	 + "cemail, "
	 + "isMissedTherapyNotification, "
	 + "settingDeviationNotification, "
	 + "nonHmrNotification, "
	...
	public static final String QUERY_PATIENT_STATISTICS_CAREGIVER_MONARCH="select puserid,pfirstname,plastname,cgvr_id,CONCAT(clastName,' ', cfirstName) as cname,pc.missed_therapy_count,pc.is_settings_deviated,pc.is_hmr_compliant,"
	+"cemail, isMissedTherapyNotification,settingDeviationNotification, nonHmrNotification  from ( "
	+"select user.id as puserid,user.first_name as pfirstName,user.last_name as plastName,upa_cgvr.user_id as cgvr_id "
	+"from USER user  "
	+"join USER_AUTHORITY user_authority on user_authority.user_id = user.id and user_authority.authority_name = 'PATIENT' "
