...
public class PatientVestDeviceTherapyMonarchUtil {
	...
	private static final Logger log = LoggerFactory.getLogger(PatientVestDeviceTherapyMonarchUtil.class);

	private PatientVestDeviceTherapyMonarchUtil(){
