    ...
    .config(function($stateProvider) {
        $stateProvider
            ...
            .state('patientAddDevice', {
                ...
                views: {
                    'content@': {
                        templateUrl: 'scripts/app/modules/admin/patient/directives/patient-info/device-protocol/add-device.html',
                        controller: 'patientsController'
                    }
                },
                resolve: {
            ...
            .state('patientAddProtocol', {
                ...
                views: {
                    'content@': {
                        templateUrl: 'scripts/app/modules/admin/patient/directives/patient-info/device-protocol/add-protocol.html',
                        controller: 'patientsController'
                    }
                },
                resolve: {
            ...
            .state('patientProfile', {
                ...
                views: {
                    'content@': {
                        templateUrl: 'scripts/app/modules/patient/profile/profile-tabs/my-profile.html',
            ...
            .state('profilePassword', {
                ...
                views: {
                    'content@': {
                        templateUrl: 'scripts/app/modules/profile/views/profile/password.html',
                        controller: 'graphController'
                    }
                },
                resolve: {
            ...
            .state('patientProfileEdit', {
                ...
                views: {
                    'content@': {
                        templateUrl: 'scripts/app/modules/patient/profile/profile-tabs/edit-my-profile.html',
                        controller: 'patientprofileController'
                    }
                },
                resolve: {
            ...
            .state('patientResetPassword', {
                ...
                views: {
                    'content@': {
                        templateUrl: 'scripts/app/modules/patient/profile/profile-tabs/update-password.html',
                        controller: 'patientprofileController'
                    }
                },
                resolve: {
